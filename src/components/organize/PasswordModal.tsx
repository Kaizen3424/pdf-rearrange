...
export default function PasswordModal({
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-label="PDF password required"
    >
      <div className="w-full max-w-sm rounded-xl bg-canvas p-6 shadow-xl">
        ...
        <h2 className="mt-4 text-display-xs font-semibold">Password required</h2>
        <p className="mt-2 text-body-md text-body">
          {fileName ? <span className="font-semibold">{fileName}</span> : 'This PDF'} is
          protected. Enter its password to open it on your device.
        </p>
        {needsRetry && (
          <p
            id="password-error"
